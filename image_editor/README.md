...
5. Чтобы узнать список доступных команд (фильтров), вводим команду `poetry run py -m filters_opencv -h`
6. Чтобы узнать аргументы команды (фильтра), вводим команду `poetry run py -m filters_opencv <команда (фильтр)> -h`
7. Чтобы выполнить команду (применить фильтр), вводим команду `poetry run py -m filters_opencv <команда (фильтр)> <путь к изображению> <путь куда сохранить> <аргументы>`

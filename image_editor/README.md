...
5. Чтобы узнать список доступных комнад (фильтров), введите команду `poetry run py -m filters_opencv -h`
6. Чтобы узнать аргументы команды (фильтра), введите команду `poetry run py -m filters_opencv <команда (фильтр)> -h`
7. Чтобы выполнить команду (применить фильтр), введите команду `poetry run py -m filters_opencv <команда (фильтр)> <путь к изображению> <путь куда сохранить> <др. аргументы>`
